...
public class AnimatorFunctions : MonoBehaviour
{
    ...
    void PlaySound1()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound1[Random.Range(0, sound1.Length)], sound1Volume);
    }

    void PlaySound2()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound2[Random.Range(0, sound2.Length)], sound2Volume);
    }

    void PlaySound3()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound3[Random.Range(0, sound3.Length)], sound3Volume);
    }

    void PlaySound4()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound4[Random.Range(0, sound4.Length)], sound4Volume);
    }

    void PlaySound5()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound5[Random.Range(0,sound5.Length)], sound5Volume);
    }

    void PlaySound6()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound6[Random.Range(0, sound6.Length)], sound6Volume);
    }

    void PlaySound7()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound7[Random.Range(0, sound7.Length)], sound7Volume);
    }

    void PlaySound8()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound8[Random.Range(0, sound8.Length)], sound8Volume);
    }

    void PlaySound9()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound9[Random.Range(0, sound9.Length)], sound9Volume);
    }

    void PlaySound10()
    {
        Player1.Instance.sfxAudioSource.PlayOneShot(sound10[Random.Range(0, sound10.Length)], sound5Volume);
    }
